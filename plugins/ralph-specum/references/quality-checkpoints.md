...
> See also: `${CLAUDE_PLUGIN_ROOT}/references/phase-rules.md` for VE placement rules. See `${CLAUDE_PLUGIN_ROOT}/references/coordinator-core.md` "VE-cleanup Skip-Forward Logic" for cleanup guarantee implementation.
...
See test-integrity.md for test integrity definitions and anti-patterns.

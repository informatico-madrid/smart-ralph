...
6. If no spec files exist, error: "No spec files found. Run /ralphharness:start first."
...
- Run /ralphharness:implement to continue execution (if tasks were modified)
```

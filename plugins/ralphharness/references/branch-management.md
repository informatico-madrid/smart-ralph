...
1. Get current branch name
   ...
   |   |   - Suggest: "Run /ralphharness:research to start the research phase."
   ...
   |   |     "Then run /ralphharness:research to begin."
...
Then run /ralphharness:research to begin the research phase.
```

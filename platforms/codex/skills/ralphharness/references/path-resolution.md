...
```bash
python3 ./platforms/codex/skills/ralphharness/scripts/resolve_spec_paths.py --cwd "$PWD"
python3 ./platforms/codex/skills/ralphharness/scripts/resolve_spec_paths.py --cwd "$PWD" --current
python3 ./platforms/codex/skills/ralphharness/scripts/resolve_spec_paths.py --cwd "$PWD" --name api-auth
python3 ./platforms/codex/skills/ralphharness/scripts/resolve_spec_paths.py --cwd "$PWD" --list
```

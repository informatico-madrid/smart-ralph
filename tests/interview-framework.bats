...
@test "plugin.json version is 4.9.4" {
    grep -q '"version": "4.9.4"' "plugins/ralph-specum/.claude-plugin/plugin.json"
}

@test "marketplace.json ralph-specum version is 4.9.4" {
